...
console.log({ str1, titleCase: titleCase(str1), expected1 });
console.log({ str2, titleCase: titleCase(str2), expected2 });
console.log({ str3, titleCase: titleCase(str3), expected3 });
console.log({ str4, titleCase: titleCase(str4), expected4 });
console.log({ str5, titleCase: titleCase(str5), expected5 });
