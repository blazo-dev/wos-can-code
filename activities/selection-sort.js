...
function selectionSort(numbers) {
  ...
  while (unsortedStart < len - 1) {
    let min = numbers[unsortedStart];
    let minIdx = unsortedStart;

    for (let i = unsortedStart; i < len; i++) {
      if (numbers[i] < min) {
        min = numbers[i];
        minIdx = i;
      }
    ...
    numbers[minIdx] = numbers[unsortedStart];
    numbers[unsortedStart] = min;
...
console.log({
  numbersOrdered: selectionSort(numbersOrdered),
  expected,
});

console.log({
  numbersRandomOrder: selectionSort(numbersRandomOrder),
  expected,
});

console.log({
  numbersReversed: selectionSort(numbersReversed),
  expected,
});
